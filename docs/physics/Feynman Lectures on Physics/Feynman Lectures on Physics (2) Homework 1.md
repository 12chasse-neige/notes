...
$$
\vec{u} \wedge \vec{v} = (u_{1} {v}_{2} - u_{2}v_{1}) (\vec{e}_{1} \wedge \vec{e}_{2}) + (u_{2}v_{3} - u_{3}v_{2}) (\vec{e}_{2} \wedge \vec{e}_{3}) + (u_{3}v_{1} - u_{1}v_{3}) (\vec{e}_{3} \wedge \vec{e}_{1}) \quad (1.1)
$$
