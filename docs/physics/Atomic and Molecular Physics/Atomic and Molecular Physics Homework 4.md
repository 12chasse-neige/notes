...
The bottom cluster originates from the ${}^{3} {P}$ term:
...
(h) $(3/2, 3/2)_{2}$ : The second highest state, connected to $^{1} {D}_{2}$.
(j) $(3/2, 1/2)_{2}$ : The upper state of the middle group ($J=2$), connected to $^{3}{P}_{2}$.
(k) $(3/2, 1/2)_{1}$ : The lower state of the middle group ($J=1$), connected to $^{3} {P}_{1}$.
