...
6.对于什么样的 $a$ 值，函数
$$
F(z) = \int_{z_{0}}^{z} \text{e}^{z} \left(\frac{1}{z} + \frac{a}{z^{3}}\right) \text{d}z
$$
...
$$
f(\zeta) = \frac{1}{2\pi} \int_{0}^{2\pi} \frac{R^{2} - r^{2}}{R^{2} - 2Rr \cos(\theta - \phi) + r^{2}} f\left(R \text{e}^{\text{i}\phi}\right) \text{d} \phi
$$
证明：设$z = R e^{i \phi}$
$$
\frac{1}{2\pi} \int_{0}^{2\pi} \frac{R^{2} - r^{2}}{R^{2} - 2Rr \cos(\theta - \phi) + r^{2}} f\left(R \text{e}^{\text{i}\phi}\right) \text{d} \phi  \\  = 
